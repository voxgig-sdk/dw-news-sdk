...
Results: Successful response with breaking news data.
...
| --- | --- | --- | --- |
| New | `load` | `GET /ru/breaking-news` | See reference |

## Connect to the API

- DW News API Server: `https://www.dw.com/graph-api`
...
- `dw-news_list`: List records for an entity. No active entity supports this operation.
- `dw-news_load`: Load one record for an entity. Supported entities: `new`.
