...
// DwNews SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DwNewsTestFeature extends DwNewsBaseFeature
{
    ...
    public function init(DwNewsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DwNewsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DwNewsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DwNewsContext $ctx, $op, $args): array
    {
