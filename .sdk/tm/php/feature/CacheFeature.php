...
class DwNewsCacheFeature extends DwNewsBaseFeature
{
    ...
    private function _through(DwNewsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
