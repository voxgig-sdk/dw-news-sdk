...
class DwNewsNetsimFeature extends DwNewsBaseFeature
{
    ...
    private function _simulate(DwNewsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DwNewsContext $ctx, array $applied): void
    {
        $client = $this->client;
