...
class DwNewsProxyFeature extends DwNewsBaseFeature
{
    ...
    public function init(DwNewsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DwNewsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
