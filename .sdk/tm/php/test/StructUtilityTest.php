...
// DwNews SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = DwNewsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(DwNewsOmni::structfix($now, Struct::undef()))
                        !== json_encode(DwNewsOmni::structfix($val, Struct::undef()))) {
