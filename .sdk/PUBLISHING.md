...
|---|---|---|
| `ts/` | @voxgig-sdk/dw-news-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/dw-news-sdk \
      --repository voxgig-sdk/dw-news-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/dw-news-sdk` shows it, and
`npm trust revoke @voxgig-sdk/dw-news-sdk --id=<id>` removes it.
