...
function envOverride(m) {
    if ('TRUE' === process.env.DW_NEWS_TEST_LIVE ||
        'TRUE' === process.env.DW_NEWS_TEST_OVERRIDE) {
    ...
    m.DW_NEWS_TEST_EXPLAIN = process.env.DW_NEWS_TEST_EXPLAIN || m.DW_NEWS_TEST_EXPLAIN;
    return m;
}
