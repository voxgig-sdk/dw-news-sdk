...
module DwNewsTestRunner
  ...
  def self.env_override(m)
    live = getenv("DWNEWS_TEST_LIVE")
    override = getenv("DWNEWS_TEST_OVERRIDE")
    ...
    explain = getenv("DWNEWS_TEST_EXPLAIN")
    m["DWNEWS_TEST_EXPLAIN"] = explain if explain && !explain.empty?
