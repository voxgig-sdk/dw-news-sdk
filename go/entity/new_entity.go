...
func NewNewEntity(client *core.DwNewsSDK, entopts map[string]any) *NewEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NewEntity) List(_ map[string]any, _ map[string]any) (any, error) {
