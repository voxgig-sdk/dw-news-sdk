...
from dwnews_sdk.core.helpers import get_ctx_prop, to_map
...
class DwNewsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, DwNewsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DwNewsError(code, msg, self)
