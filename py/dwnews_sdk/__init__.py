...
from dwnews_sdk.utility import register

# Load features
from dwnews_sdk.feature.base_feature import DwNewsBaseFeature
from dwnews_sdk.features import _has_feature, _make_feature
...
class DwNewsSDK:
    ...
    def get_utility(self):
        return DwNewsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DwNewsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def New(self, data=None) -> "NewEntity":
        ...
        from dwnews_sdk.entity.new_entity import NewEntity
        return NewEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "DwNewsSDK":
        if sdkopts is None:
            sdkopts = {}
