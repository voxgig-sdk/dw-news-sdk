...
from dwnews_sdk.core.response import DwNewsResponse
from dwnews_sdk.core.operation import DwNewsOperation
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = DwNewsSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = DwNewsSDK.test(None, None)
        ...
        class TestInitFeature(DwNewsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(DwNewsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = DwNewsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = DwNewsSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = DwNewsSDK.test(None, setup_opts)
