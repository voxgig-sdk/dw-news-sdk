...
class DwNewsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DwNewsTestRunner.getenv("DW_NEWS_TEST_LIVE")
        override = DwNewsTestRunner.getenv("DW_NEWS_TEST_OVERRIDE")
        ...
        explain = DwNewsTestRunner.getenv("DW_NEWS_TEST_EXPLAIN")
