# DwNews SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DwNewsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DwNewsSDK(...) and DwNewsSDK.test(...) become
#      DwNewsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "dwnews_sdk"
_SDK_CLASS = "DwNewsSDK"
