...
func registerTools(server *mcp.Server, client *sdk.DwNewsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "dw-news_list",
		Description: "List records from DwNews. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "dw-news_load",
		Description: "Load a single record from DwNews. " +
...
func runOp(client *sdk.DwNewsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DwNewsSDK, name string) (sdk.DwNewsEntity, error) {
