...
DW News API client, generated from the OpenAPI spec.

This API provides access to news, off-beat stories, and in-depth analysis related to German and international affairs from dw.com.

Learn more about DW News API at [github.com/l0v3m0n3y/dw](https://github.com/l0v3m0n3y/dw).

This is an unofficial SDK for the DW News public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/dw-news` | publish pending — [install from git tag](https://github.com/voxgig-sdk/dw-news-sdk/releases) |
...
```bash
cd go-mcp && go build -o dw-news-mcp .
```
...
```json
{
  "mcpServers": {
    "dw-news": {
      "command": "/abs/path/to/dw-news-mcp"
    }
  }
}
```
...
| --- | --- | --- |
| **New** | The New entity (load). | `/ru/breaking-news` |
...
```go
import sdk "github.com/voxgig-sdk/dw-news-sdk/go"
...
Generated from the DW News API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
