...
func registerSDKWords(r *eng.Registry, client *sdk.DwNewsSDK) {
...
func runOp(client *sdk.DwNewsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
