...
class DwNewsRbacFeature extends DwNewsBaseFeature
{
    ...
    private function _required(DwNewsContext $ctx): ?string
    {
    ...
    private function _reject(DwNewsContext $ctx, string $required): void
    {
    ...
    private function _track(DwNewsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
