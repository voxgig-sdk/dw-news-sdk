...
class DwNewsTimeoutFeature extends DwNewsBaseFeature
{
    ...
    private function _with_timeout(DwNewsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DwNewsContext $_ctx, float $ms): void
    {
        $client = $this->client;
