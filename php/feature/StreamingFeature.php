...
class DwNewsStreamingFeature extends DwNewsBaseFeature
{
    ...
    private function _iterate(DwNewsResult $result): \Generator
    {
    ...
    private function _streamable(DwNewsContext $ctx): bool
    {
