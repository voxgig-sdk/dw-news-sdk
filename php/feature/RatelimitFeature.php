...
class DwNewsRatelimitFeature extends DwNewsBaseFeature
{
    ...
    private function _acquire(DwNewsContext $ctx): void
    {
    ...
    private function _track(DwNewsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
