...
// DwNews SDK clienttrack feature
...
class DwNewsClienttrackFeature extends DwNewsBaseFeature
{
    ...
    public function PostConstruct(DwNewsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'DwNews-SDK';
