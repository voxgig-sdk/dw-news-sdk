...
class DwNewsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DwNewsSDK/1.0)';
    ...
    public static function call(DwNewsContext $ctx, string $fullurl, array $fetchdef): array
    {
