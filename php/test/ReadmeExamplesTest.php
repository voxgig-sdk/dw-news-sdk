...
// DwNews SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DwNewsSDK::test)
...
{
    private const SDK_CLASS = 'DwNewsSDK';
    ...
    private const SDK_BASE = 'dwnews_sdk';
