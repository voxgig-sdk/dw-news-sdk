...
DwNewsSDK._make_feature = _make_feature


function DwNewsSDK.new(options)
  local self = setmetatable({}, DwNewsSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function DwNewsSDK:options_map()
...
function DwNewsSDK:get_utility()
  return Utility.copy(self._utility)
end


function DwNewsSDK:get_root_ctx()
  return self._rootctx
end


function DwNewsSDK:prepare(fetchargs)
...
function DwNewsSDK:direct(fetchargs)
...
-- by passing it.
function DwNewsSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function DwNewsSDK:graphql(query, variables, ctrl)
...
function DwNewsSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = DwNewsSDK.new(sdkopts)
  sdk.mode = "test"
