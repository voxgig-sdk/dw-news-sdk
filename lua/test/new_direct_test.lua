...
describe("NewDirect", function()
  it("should direct-load-new", function()
    local setup = new_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-new", setup.live and "live" or "unit")
